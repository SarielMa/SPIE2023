...
from nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset, MyDataLoader2D,MyTrainDataLoader2D
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def run_our_training(self, counter):
        self.save_debug_information()
        super(nnUNetTrainer, self).run_our_training(counter)
    ...
    def my_filter_out(self, target, n_classes):
        #filter out those lacking classes, not used in this experiment. We filtered out from the dataloader part
